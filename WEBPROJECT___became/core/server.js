...
app.use('/ressources',express.static('public/files/ressources'))
app.use('/courses',express.static('public/files/courses'))
...
// app.get('/_/filieres/:id',(req,res)=>{console.log("yoyoyoy\n\n\n\n\n\n\n\n\n\n");rsc.filieres(req,res)})
